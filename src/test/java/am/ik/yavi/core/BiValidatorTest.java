...
class BiValidatorTest {
	...
	final BiValidator<User, List<ConstraintViolation>> validator = ValidatorBuilder.of(User.class)
		...
		.build((errors, name, messageKey, args, defaultMessage) -> errors.add(new ConstraintViolation(name, messageKey,
