...
/**
 * A common YAVI annotation (similar to Spring one) to declare that parameters and return
 ...
 * support and used by Kotlin to infer nullability of YAVI API.
 *
 * <p>
