...
public class Arguments9Combining<A, R1, R2, R3, R4, R5, R6, R7, R8, R9> {
	...
	public <X> Arguments1Validator<A, X> apply(Function9<? super R1, ? super R2, ? super R3, ? super R4, ? super R5, ? super R6, ? super R7, ? super R8, ? super R9, ? extends X> f) {
	...
	public <R10> Arguments10Combining<A, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10> combine(ValueValidator<? super A, ? extends R10> v10) {
