 ...
 * @since 0.7.0
 */
public class Arguments9Combining<A1, A2, A3, A4, A5, A6, A7, A8, A9, X1, X2, X3, X4, X5, X6, X7, X8, X9> {
	...
	public Arguments9Combining(Arguments1Validator<A1, X1> v1,
	...
	public <X> Arguments9Validator<A1, A2, A3, A4, A5, A6, A7, A8, A9, X> apply(
			Function9<X1, X2, X3, X4, X5, X6, X7, X8, X9, X> f) {
	...
	public <A10, X10> Arguments10Combining<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10> combine(
