...
public class ArgumentsValidators {
	...
	public static <A1, R, T> Arguments1Validator<A1, List<R>> traverse1(
		...
		return (a1, locale, constraintGroup) ->
			Validated.traverse(values, f.andThen(validator -> validator.validate(a1, locale, constraintGroup)));
	}
	...
	public static <A1, A2, R, T> Arguments2Validator<A1, A2, List<R>> traverse2(
		...
		return (a1, a2, locale, constraintGroup) ->
			Validated.traverse(values, f.andThen(validator -> validator.validate(a1, a2, locale, constraintGroup)));
	}
	...
	public static <A1, A2, A3, R, T> Arguments3Validator<A1, A2, A3, List<R>> traverse3(
		...
		return (a1, a2, a3, locale, constraintGroup) ->
			Validated.traverse(values, f.andThen(validator -> validator.validate(a1, a2, a3, locale, constraintGroup)));
	}
	...
	public static <A1, A2, A3, A4, R, T> Arguments4Validator<A1, A2, A3, A4, List<R>> traverse4(
		...
		return (a1, a2, a3, a4, locale, constraintGroup) ->
			Validated.traverse(values, f.andThen(validator -> validator.validate(a1, a2, a3, a4, locale, constraintGroup)));
	}
	...
	public static <A1, A2, A3, A4, A5, R, T> Arguments5Validator<A1, A2, A3, A4, A5, List<R>> traverse5(
		...
		return (a1, a2, a3, a4, a5, locale, constraintGroup) ->
			Validated.traverse(values, f.andThen(validator -> validator.validate(a1, a2, a3, a4, a5, locale, constraintGroup)));
	}
	...
	public static <A1, A2, A3, A4, A5, A6, R, T> Arguments6Validator<A1, A2, A3, A4, A5, A6, List<R>> traverse6(
		...
		return (a1, a2, a3, a4, a5, a6, locale, constraintGroup) ->
			Validated.traverse(values, f.andThen(validator -> validator.validate(a1, a2, a3, a4, a5, a6, locale, constraintGroup)));
	}
	...
	public static <A1, A2, A3, A4, A5, A6, A7, R, T> Arguments7Validator<A1, A2, A3, A4, A5, A6, A7, List<R>> traverse7(
		...
		return (a1, a2, a3, a4, a5, a6, a7, locale, constraintGroup) ->
			Validated.traverse(values, f.andThen(validator -> validator.validate(a1, a2, a3, a4, a5, a6, a7, locale, constraintGroup)));
	}
	...
	public static <A1, A2, A3, A4, A5, A6, A7, A8, R, T> Arguments8Validator<A1, A2, A3, A4, A5, A6, A7, A8, List<R>> traverse8(
		...
		return (a1, a2, a3, a4, a5, a6, a7, a8, locale, constraintGroup) ->
			Validated.traverse(values, f.andThen(validator -> validator.validate(a1, a2, a3, a4, a5, a6, a7, a8, locale, constraintGroup)));
	}
	...
	public static <A1, A2, A3, A4, A5, A6, A7, A8, A9, R, T> Arguments9Validator<A1, A2, A3, A4, A5, A6, A7, A8, A9, List<R>> traverse9(
		...
		return (a1, a2, a3, a4, a5, a6, a7, a8, a9, locale, constraintGroup) ->
			Validated.traverse(values, f.andThen(validator -> validator.validate(a1, a2, a3, a4, a5, a6, a7, a8, a9, locale, constraintGroup)));
	}
	...
	public static <A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R, T> Arguments10Validator<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, List<R>> traverse10(
		...
		return (a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, locale, constraintGroup) ->
			Validated.traverse(values, f.andThen(validator -> validator.validate(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, locale, constraintGroup)));
	}
