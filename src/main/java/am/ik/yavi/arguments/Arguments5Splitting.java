...
public class Arguments5Splitting<A1, A2, A3, A4, A5, R1, R2, R3, R4, R5> {
	...
	public Arguments5Splitting(ValueValidator<? super A1, ? extends R1> v1, ValueValidator<? super A2, ? extends R2> v2, ValueValidator<? super A3, ? extends R3> v3, ValueValidator<? super A4, ? extends R4> v4, ValueValidator<? super A5, ? extends R5> v5) {
		this.v1 = v1;
		this.v2 = v2;
		this.v3 = v3;
		this.v4 = v4;
		...
		return new Arguments5Validator<A1, A2, A3, A4, A5, X>() {
			...
			public Arguments5Validator<A1, A2, A3, A4, A5, Supplier<X>> lazy() {
				return ((a1, a2, a3, a4, a5, locale, constraintContext) -> Validations.apply(
						...
						v1.validate(a1, locale, constraintContext), v2.validate(a2, locale, constraintContext), v3.validate(a3, locale, constraintContext), v4.validate(a4, locale, constraintContext), v5.validate(a5, locale, constraintContext)));
			}

			@Override
			public Validated<X> validate(@Nullable A1 a1, @Nullable A2 a2, @Nullable A3 a3, @Nullable A4 a4, @Nullable A5 a5, Locale locale,
	...
	public <A6, R6> Arguments6Splitting<A1, A2, A3, A4, A5, A6, R1, R2, R3, R4, R5, R6> split(ValueValidator<? super A6, ? extends R6> v6) {
