 ...
 * @since 0.7.0
 */
public class Arguments6Mapping<A, R1, R2, R3, R4, R5, R6> {
	...
	public Arguments6Mapping(Arguments1Validator<A, R1> v1, Arguments1Validator<A, R2> v2,
	...
	public <X> Arguments1Validator<A, X> apply(Function6<R1, R2, R3, R4, R5, R6, X> f) {
	...
	public <R7> Arguments7Mapping<A, R1, R2, R3, R4, R5, R6, R7> map7(
			Arguments1Validator<A, R7> v7) {
		return new Arguments7Mapping<>(v1, v2, v3, v4, v5, v6, v7);
	}
}
