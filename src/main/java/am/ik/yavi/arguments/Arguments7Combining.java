	...
	public <X> Arguments1Validator<A, X> apply(
		...
		return new Arguments1Validator<A, X>() {
			...
			public Validated<X> validate(A a, Locale locale, ConstraintContext constraintContext) {
				return Validations.apply(f::apply, Arguments7Combining.this.v1.validate(a, locale, constraintContext),
						Arguments7Combining.this.v2.validate(a, locale, constraintContext),
						Arguments7Combining.this.v3.validate(a, locale, constraintContext),
						Arguments7Combining.this.v4.validate(a, locale, constraintContext),
						Arguments7Combining.this.v5.validate(a, locale, constraintContext),
						Arguments7Combining.this.v6.validate(a, locale, constraintContext),
						Arguments7Combining.this.v7.validate(a, locale, constraintContext));
			}
			...
			public Arguments1Validator<A, Supplier<X>> lazy() {
				return (a, locale, constraintContext) -> Validations.apply(
						...
						Arguments7Combining.this.v1.validate(a, locale, constraintContext),
						Arguments7Combining.this.v2.validate(a, locale, constraintContext),
						Arguments7Combining.this.v3.validate(a, locale, constraintContext),
						Arguments7Combining.this.v4.validate(a, locale, constraintContext),
						Arguments7Combining.this.v5.validate(a, locale, constraintContext),
