...
public class Arguments7Combining<A, R1, R2, R3, R4, R5, R6, R7> {
	...
	public Arguments7Combining(ValueValidator<? super A, ? extends R1> v1, ValueValidator<? super A, ? extends R2> v2, ValueValidator<? super A, ? extends R3> v3, ValueValidator<? super A, ? extends R4> v4, ValueValidator<? super A, ? extends R5> v5, ValueValidator<? super A, ? extends R6> v6, ValueValidator<? super A, ? extends R7> v7) {
		this.v1 = v1;
		this.v2 = v2;
		this.v3 = v3;
		this.v4 = v4;
	...
	public <X> Arguments1Validator<A, X> apply(Function7<? super R1, ? super R2, ? super R3, ? super R4, ? super R5, ? super R6, ? super R7, ? extends X> f) {
	...
	public <R8> Arguments8Combining<A, R1, R2, R3, R4, R5, R6, R7, R8> combine(ValueValidator<? super A, ? extends R8> v8) {
