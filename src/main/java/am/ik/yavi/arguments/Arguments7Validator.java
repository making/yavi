...
public final class Arguments7Validator<A1, A2, A3, A4, A5, A6, A7, X>
	...
	public Validation<ConstraintViolation, X> validateArgs(A1 a1, A2 a2, A3 a3, A4 a4,
			A5 a5, A6 a6, A7 a7, ConstraintGroup constraintGroup) {
		return this
				.applicative().validate(Arguments.of(a1, a2, a3, a4, a5, a6, a7),
	...
	public Validation<ConstraintViolation, X> validateArgs(A1 a1, A2 a2, A3 a3, A4 a4,
			A5 a5, A6 a6, A7 a7, Locale locale) {
		return this.applicative().validate(Arguments.of(a1, a2, a3, a4, a5, a6, a7),
				locale, ConstraintGroup.DEFAULT).map(values -> values.map(this.mapper));
	}

	public Validation<ConstraintViolation, X> validateArgs(A1 a1, A2 a2, A3 a3, A4 a4,
			A5 a5, A6 a6, A7 a7, Locale locale, ConstraintGroup constraintGroup) {
		return this.applicative().validate(Arguments.of(a1, a2, a3, a4, a5, a6, a7),
