...
public interface Arguments7Validator<A1, A2, A3, A4, A5, A6, A7, X> {
	...
	/**
	 * Convert an Arguments1Validator that validates Arguments7 to an Arguments7Validator
	 * @param validator validator for Arguments7
	 ...
	 * @return arguments7 validator that takes arguments directly
	 * @since 0.16.0
	 */
	static <A1, A2, A3, A4, A5, A6, A7, X> Arguments7Validator<A1, A2, A3, A4, A5, A6, A7, X> unwrap(
		...
		return new Arguments7Validator<A1, A2, A3, A4, A5, A6, A7, X>() {
			...
			public Validated<X> validate(@Nullable A1 a1, @Nullable A2 a2, @Nullable A3 a3, @Nullable A4 a4,
					@Nullable A5 a5, @Nullable A6 a6, @Nullable A7 a7, Locale locale,
					ConstraintContext constraintContext) {
				return validator.validate(Arguments.of(a1, a2, a3, a4, a5, a6, a7), locale, constraintContext);
			}
	...
	/**
	 * Convert this validator to one that validates Arguments7 as a single object.
	 * @return a validator that takes an Arguments7
	 * @since 0.16.0
	 */
	default Arguments1Validator<Arguments7<A1, A2, A3, A4, A5, A6, A7>, X> wrap() {
		return new Arguments1Validator<Arguments7<A1, A2, A3, A4, A5, A6, A7>, X>() {
			@Override
			public Validated<X> validate(Arguments7<A1, A2, A3, A4, A5, A6, A7> args, Locale locale,
					ConstraintContext constraintContext) {
				final Arguments7<? extends A1, ? extends A2, ? extends A3, ? extends A4, ? extends A5, ? extends A6, ? extends A7> nonNullArgs = Objects
					.requireNonNull(args);
				return Arguments7Validator.this.validate(nonNullArgs.arg1(), nonNullArgs.arg2(), nonNullArgs.arg3(),
						nonNullArgs.arg4(), nonNullArgs.arg5(), nonNullArgs.arg6(), nonNullArgs.arg7(), locale,
						constraintContext);
			}

			@Override
			public Arguments1Validator<Arguments7<A1, A2, A3, A4, A5, A6, A7>, Supplier<X>> lazy() {
				return Arguments7Validator.this.lazy().wrap();
			}
		};
	}
		...
		return new Arguments1Validator<A, X>() {
			...
			public Validated<X> validate(A a, Locale locale, ConstraintContext constraintContext) {
				final Arguments7<? extends A1, ? extends A2, ? extends A3, ? extends A4, ? extends A5, ? extends A6, ? extends A7> args = mapper
					.apply(a);
				return Arguments7Validator.this.validate(args.arg1(), args.arg2(), args.arg3(), args.arg4(),
						args.arg5(), args.arg6(), args.arg7(), locale, constraintContext);
			}

			@Override
			public Arguments1Validator<A, Supplier<X>> lazy() {
				return Arguments7Validator.this.lazy().compose(mapper);
			}
		};
	}
	...
	default X validated(@Nullable A1 a1, @Nullable A2 a2, @Nullable A3 a3, @Nullable A4 a4, @Nullable A5 a5,
			@Nullable A6 a6, @Nullable A7 a7) throws ConstraintViolationsException {
	...
	default X validated(@Nullable A1 a1, @Nullable A2 a2, @Nullable A3 a3, @Nullable A4 a4, @Nullable A5 a5,
			@Nullable A6 a6, @Nullable A7 a7, Locale locale) throws ConstraintViolationsException {
