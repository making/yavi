...
public class Arguments16Combining<A, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13, R14, R15, R16> {
	...
	public Arguments16Combining(ValueValidator<? super A, ? extends R1> v1, ValueValidator<? super A, ? extends R2> v2,
	...
	public <X> Arguments1Validator<A, X> apply(
		...
		return new Arguments1Validator<A, X>() {
			...
			public Validated<X> validate(A a, Locale locale, ConstraintContext constraintContext) {
				return Validations.apply(f::apply, Arguments16Combining.this.v1.validate(a, locale, constraintContext),
						...
						Arguments16Combining.this.v15.validate(a, locale, constraintContext),
			...
			public Arguments1Validator<A, Supplier<X>> lazy() {
				return (a, locale, constraintContext) -> Validations.apply(
						(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15,
								r16) -> () -> f.apply(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15,
										r16),
						Arguments16Combining.this.v1.validate(a, locale, constraintContext),
						Arguments16Combining.this.v2.validate(a, locale, constraintContext),
						Arguments16Combining.this.v3.validate(a, locale, constraintContext),
						Arguments16Combining.this.v4.validate(a, locale, constraintContext),
						Arguments16Combining.this.v5.validate(a, locale, constraintContext),
