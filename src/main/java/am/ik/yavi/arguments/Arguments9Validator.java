...
public final class Arguments9Validator<A1, A2, A3, A4, A5, A6, A7, A8, A9, X> {
	private final Validator<Arguments9<A1, A2, A3, A4, A5, A6, A7, A8, A9>> validator;
	...
	public Validated<X> validate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8,
		...
		return this.validator
				.applicative().validate(Arguments.of(a1, a2, a3, a4, a5, a6, a7, a8, a9),
						locale, ConstraintGroup.DEFAULT)
				.map(values -> values.map(this.mapper));
	}

	public Validated<X> validate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7, A8 a8,
			A9 a9, Locale locale, ConstraintGroup constraintGroup) {
		return this.validator.applicative()
	...
	public void validateAndThrowIfInvalid(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7,
			A8 a8, A9 a9) {
		this.validator.validate(Arguments.of(a1, a2, a3, a4, a5, a6, a7, a8, a9))
