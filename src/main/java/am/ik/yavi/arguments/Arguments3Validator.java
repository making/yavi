...
public interface Arguments3Validator<A1, A2, A3, X> {
	...
	default Validated<X> validate(@Nullable A1 a1, @Nullable A2 a2, @Nullable A3 a3, ConstraintContext constraintContext) {
	...
	default X validated(@Nullable A1 a1, @Nullable A2 a2, @Nullable A3 a3, Locale locale) throws ConstraintViolationsException {
		return this.validate(a1, a2, a3, locale).orElseThrow(ConstraintViolationsException::new);
	}

	default X validated(@Nullable A1 a1, @Nullable A2 a2, @Nullable A3 a3, Locale locale, ConstraintContext constraintContext)
			throws ConstraintViolationsException {
