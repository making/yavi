...
public final class Arguments4Validator<A1, A2, A3, A4, X>
	...
	public ConstraintViolations validateArgs(A1 a1, A2 a2, A3 a3, A4 a4,
			ConstraintGroup constraintGroup) {
		return this.validate(Arguments.of(a1, a2, a3, a4), Locale.getDefault(),
				constraintGroup);
	}

	public ConstraintViolations validateArgs(A1 a1, A2 a2, A3 a3, A4 a4, Locale locale) {
		return this.validate(Arguments.of(a1, a2, a3, a4), locale,
				ConstraintGroup.DEFAULT);
	}

	public ConstraintViolations validateArgs(A1 a1, A2 a2, A3 a3, A4 a4, Locale locale,
			ConstraintGroup constraintGroup) {
		return this.validate(Arguments.of(a1, a2, a3, a4), locale, constraintGroup);
	}
	...
	public Either<ConstraintViolations, X> validateArgsToEither(A1 a1, A2 a2, A3 a3,
			A4 a4, ConstraintGroup constraintGroup) {
	...
	public Either<ConstraintViolations, X> validateArgsToEither(A1 a1, A2 a2, A3 a3,
			A4 a4, Locale locale, ConstraintGroup constraintGroup) {
