...
public class Arguments6Combining<A, R1, R2, R3, R4, R5, R6> {
	...
	public Arguments6Combining(ValueValidator<? super A, ? extends R1> v1, ValueValidator<? super A, ? extends R2> v2,
	...
	public <X> Arguments1Validator<A, X> apply(
		...
		return new Arguments1Validator<A, X>() {
			...
			public Validated<X> validate(A a, Locale locale, ConstraintContext constraintContext) {
				return Validations.apply(f::apply, Arguments6Combining.this.v1.validate(a, locale, constraintContext),
			...
			public Arguments1Validator<A, Supplier<X>> lazy() {
				return (a, locale, constraintContext) -> Validations.apply(
						...
						Arguments6Combining.this.v1.validate(a, locale, constraintContext),
						Arguments6Combining.this.v2.validate(a, locale, constraintContext),
						Arguments6Combining.this.v3.validate(a, locale, constraintContext),
						Arguments6Combining.this.v4.validate(a, locale, constraintContext),
						Arguments6Combining.this.v5.validate(a, locale, constraintContext),
