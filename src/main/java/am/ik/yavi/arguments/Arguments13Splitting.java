...
public class Arguments13Splitting<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, R11, R12, R13> {
	...
	public <X> Arguments13Validator<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13, X> apply(
		...
		return (a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12, a13, locale, constraintContext) -> Validations.apply(
				...
				this.v2.validate(a2, locale, constraintContext), this.v3.validate(a3, locale, constraintContext),
				this.v4.validate(a4, locale, constraintContext), this.v5.validate(a5, locale, constraintContext),
				this.v6.validate(a6, locale, constraintContext), this.v7.validate(a7, locale, constraintContext),
				this.v8.validate(a8, locale, constraintContext), this.v9.validate(a9, locale, constraintContext),
				this.v10.validate(a10, locale, constraintContext), this.v11.validate(a11, locale, constraintContext),
				this.v12.validate(a12, locale, constraintContext), this.v13.validate(a13, locale, constraintContext));
	}
