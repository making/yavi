...
public final class Arguments12Validator<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, X>
	...
	public ConstraintViolations validateArgs(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6,
			A7 a7, A8 a8, A9 a9, A10 a10, A11 a11, A12 a12, Locale locale) {
		return this.validate(
				Arguments.of(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12), locale,
	...
	public Either<ConstraintViolations, X> validateArgsToEither(A1 a1, A2 a2, A3 a3,
		...
		if (violations.isValid()) {
			return Either
					.right(Arguments.of(a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11, a12)
							.map(this.mapper));
		}
		else {
