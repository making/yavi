 ...
 * @since 0.7.0
 */
public class Arguments10Splitting<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, X1, X2, X3, X4, X5, X6, X7, X8, X9, X10> {
	...
	protected final Arguments1Validator<A10, X10> v10;

	public Arguments10Splitting(Arguments1Validator<A1, X1> v1,
	...
	public <X> Arguments10Validator<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, X> apply(
			Function10<? super X1, ? super X2, ? super X3, ? super X4, ? super X5, ? super X6, ? super X7, ? super X8, ? super X9, ? super X10, ? extends X> f) {
