	...
	public <X> Arguments1Validator<A, X> apply(
		...
		return new Arguments1Validator<A, X>() {
			...
			public Validated<X> validate(A a, Locale locale, ConstraintContext constraintContext) {
				return Validations.apply(f::apply, Arguments15Combining.this.v1.validate(a, locale, constraintContext),
						...
						Arguments15Combining.this.v15.validate(a, locale, constraintContext));
			}
				...
				return (a, locale,
						constraintContext) -> Validations.apply(
								(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14,
										r15) -> () -> f.apply(r1, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13,
												r14, r15),
								Arguments15Combining.this.v1.validate(a, locale, constraintContext),
								Arguments15Combining.this.v2.validate(a, locale, constraintContext),
								Arguments15Combining.this.v3.validate(a, locale, constraintContext),
								Arguments15Combining.this.v4.validate(a, locale, constraintContext),
								Arguments15Combining.this.v5.validate(a, locale, constraintContext),
