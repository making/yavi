...
/**
 * A container class that holds 7 arguments, providing type-safe access to each argument
...
public class Arguments7<A1, A2, A3, A4, A5, A6, A7> {
	 ...
	 * position 5, arg6 the argument at position 6, arg7 the argument at position 7
	 */
	 ...
	 * @return an Arguments1 instance with arguments from arg7 to arg7
	 * @since 0.16.0
	 */
	public final Arguments1<A7> last1() {
		return new Arguments1<>(arg7);
	}

	/**
	 * Returns a new Arguments2 instance containing only the last 2 arguments.
	 * @return an Arguments2 instance with arguments from arg6 to arg7
	 * @since 0.16.0
	 */
	public final Arguments2<A6, A7> last2() {
		return new Arguments2<>(arg6, arg7);
	}

	/**
	 * Returns a new Arguments3 instance containing only the last 3 arguments.
	 * @return an Arguments3 instance with arguments from arg5 to arg7
	 * @since 0.16.0
	 */
	public final Arguments3<A5, A6, A7> last3() {
		return new Arguments3<>(arg5, arg6, arg7);
	}

	/**
	 * Returns a new Arguments4 instance containing only the last 4 arguments.
	 * @return an Arguments4 instance with arguments from arg4 to arg7
	 * @since 0.16.0
	 */
	public final Arguments4<A4, A5, A6, A7> last4() {
		return new Arguments4<>(arg4, arg5, arg6, arg7);
	}

	/**
	 * Returns a new Arguments5 instance containing only the last 5 arguments.
	 * @return an Arguments5 instance with arguments from arg3 to arg7
	 * @since 0.16.0
	 */
	public final Arguments5<A3, A4, A5, A6, A7> last5() {
		return new Arguments5<>(arg3, arg4, arg5, arg6, arg7);
	}

	/**
	 * Returns a new Arguments6 instance containing only the last 6 arguments.
	 * @return an Arguments6 instance with arguments from arg2 to arg7
	 * @since 0.16.0
	 */
	public final Arguments6<A2, A3, A4, A5, A6, A7> last6() {
		return new Arguments6<>(arg2, arg3, arg4, arg5, arg6, arg7);
	}
	 ...
	 * @return a new Arguments8 instance with the additional argument
	 * @since 0.16.0
	 */
	public final <B> Arguments8<A1, A2, A3, A4, A5, A6, A7, B> append(@Nullable B arg) {
		return new Arguments8<>(this.arg1, this.arg2, this.arg3, this.arg4, this.arg5, this.arg6, this.arg7, arg);
	}
	 ...
	 * @since 0.16.0
	 */
	public final <B> Arguments8<B, A1, A2, A3, A4, A5, A6, A7> prepend(@Nullable B arg) {
		return new Arguments8<>(arg, this.arg1, this.arg2, this.arg3, this.arg4, this.arg5, this.arg6, this.arg7);
	}

	/**
	 * Returns a new Arguments7 instance with the arguments in reverse order.
	 * @return an Arguments7 instance with arguments in reverse order
	 * @since 0.16.0
	 */
	public final Arguments7<A7, A6, A5, A4, A3, A2, A1> reverse() {
		return new Arguments7<>(arg7, arg6, arg5, arg4, arg3, arg2, arg1);
	}
	...
	public boolean equals(@Nullable Object obj) {
		...
		return Objects.equals(this.arg1, that.arg1) && Objects.equals(this.arg2, that.arg2)
				...
				&& Objects.equals(this.arg7, that.arg7);
	}
	...
	public String toString() {
		return "Arguments7{" + "arg1=" + this.arg1 + ", " + "arg2=" + this.arg2 + ", " + "arg3=" + this.arg3 + ", "
