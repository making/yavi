 ...
 * @since 0.7.0
 */
public class Arguments4Mapping<A, R1, R2, R3, R4> {
	...
	public Arguments4Mapping(Arguments1Validator<A, R1> v1, Arguments1Validator<A, R2> v2,
	...
	public <R5> Arguments5Mapping<A, R1, R2, R3, R4, R5> map5(
			Arguments1Validator<A, R5> v5) {
		return new Arguments5Mapping<>(v1, v2, v3, v4, v5);
	}
}
