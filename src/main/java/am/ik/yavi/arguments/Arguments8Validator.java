...
public final class Arguments8Validator<A1, A2, A3, A4, A5, A6, A7, A8, X>
	...
	public ConstraintViolations validateArgs(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6,
			A7 a7, A8 a8, ConstraintGroup constraintGroup) {
		return this.validate(Arguments.of(a1, a2, a3, a4, a5, a6, a7, a8),
				Locale.getDefault(), constraintGroup);
	}

	public ConstraintViolations validateArgs(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6,
			A7 a7, A8 a8, Locale locale) {
		return this.validate(Arguments.of(a1, a2, a3, a4, a5, a6, a7, a8), locale,
				ConstraintGroup.DEFAULT);
	}

	public ConstraintViolations validateArgs(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6,
			A7 a7, A8 a8, Locale locale, ConstraintGroup constraintGroup) {
		return this.validate(Arguments.of(a1, a2, a3, a4, a5, a6, a7, a8), locale,
				constraintGroup);
	}
	...
	public Either<ConstraintViolations, X> validateArgsToEither(A1 a1, A2 a2, A3 a3,
			A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, ConstraintGroup constraintGroup) {
		return this
				.validateToEither(Arguments.of(a1, a2, a3, a4, a5, a6, a7, a8),
						Locale.getDefault(), constraintGroup)
				.rightMap(values -> values.map(this.mapper));
	...
	public Either<ConstraintViolations, X> validateArgsToEither(A1 a1, A2 a2, A3 a3,
			A4 a4, A5 a5, A6 a6, A7 a7, A8 a8, Locale locale) {
		return this
