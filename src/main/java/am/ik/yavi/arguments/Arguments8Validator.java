...
public final class Arguments8Validator<A1, A2, A3, A4, A5, A6, A7, A8, X>
	...
	public Validation<ConstraintViolation, X> validateArgs(A1 a1, A2 a2, A3 a3, A4 a4,
			A5 a5, A6 a6, A7 a7, A8 a8, ConstraintGroup constraintGroup) {
		return this.applicative()
				.validate(Arguments.of(a1, a2, a3, a4, a5, a6, a7, a8),
	...
	public Validation<ConstraintViolation, X> validateArgs(A1 a1, A2 a2, A3 a3, A4 a4,
			A5 a5, A6 a6, A7 a7, A8 a8, Locale locale) {
		return this
	...
	public Validation<ConstraintViolation, X> validateArgs(A1 a1, A2 a2, A3 a3, A4 a4,
			A5 a5, A6 a6, A7 a7, A8 a8, Locale locale, ConstraintGroup constraintGroup) {
		return this.applicative().validate(Arguments.of(a1, a2, a3, a4, a5, a6, a7, a8),
				locale, constraintGroup).map(values -> values.map(this.mapper));
	}

	public void validateAndThrowIfInvalid(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7,
			A8 a8) {
		this.validate(Arguments.of(a1, a2, a3, a4, a5, a6, a7, a8))
				.throwIfInvalid(ConstraintViolationsException::new);
	}

	public void validateAndThrowIfInvalid(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, A6 a6, A7 a7,
			A8 a8, ConstraintGroup constraintGroup) {
		this.validate(Arguments.of(a1, a2, a3, a4, a5, a6, a7, a8), constraintGroup)
				.throwIfInvalid(ConstraintViolationsException::new);
	}
