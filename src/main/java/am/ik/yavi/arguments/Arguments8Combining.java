...
public class Arguments8Combining<A, R1, R2, R3, R4, R5, R6, R7, R8> {
	...
	public <X> Arguments1Validator<A, X> apply(Function8<? super R1, ? super R2, ? super R3, ? super R4, ? super R5, ? super R6, ? super R7, ? super R8, ? extends X> f) {
	...
	public <R9> Arguments9Combining<A, R1, R2, R3, R4, R5, R6, R7, R8, R9> combine(ValueValidator<? super A, ? extends R9> v9) {
