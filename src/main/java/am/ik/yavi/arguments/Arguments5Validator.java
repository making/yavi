...
public final class Arguments5Validator<A1, A2, A3, A4, A5, X> {
	private final Validator<Arguments5<A1, A2, A3, A4, A5>> validator;
	private final Function5<? super A1, ? super A2, ? super A3, ? super A4, ? super A5, ? extends X> mapper;

	public Arguments5Validator(Validator<Arguments5<A1, A2, A3, A4, A5>> validator,
			Function5<? super A1, ? super A2, ? super A3, ? super A4, ? super A5, ? extends X> mapper) {
		this.validator = validator;
		this.mapper = mapper;
	}

	public Validated<X> validate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5) {
		return this.validator
				.applicative().validate(Arguments.of(a1, a2, a3, a4, a5),
	...
	public Validated<X> validate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, Locale locale) {
		return this.validator.applicative().validate(Arguments.of(a1, a2, a3, a4, a5),
	...
	public Validated<X> validate(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, Locale locale,
		...
		return this.validator.applicative()
				.validate(Arguments.of(a1, a2, a3, a4, a5), locale, constraintGroup)
				.map(values -> values.map(this.mapper));
	}
	 ...
	 */
	@Deprecated
	public Validated<X> validateArgs(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5) {
		return this.validator
				.applicative().validate(Arguments.of(a1, a2, a3, a4, a5),
						Locale.getDefault(), ConstraintGroup.DEFAULT)
				.map(values -> values.map(this.mapper));
	 ...
	 */
	@Deprecated
	public Validated<X> validateArgs(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5, Locale locale) {
		return this.validator.applicative().validate(Arguments.of(a1, a2, a3, a4, a5),
				locale, ConstraintGroup.DEFAULT).map(values -> values.map(this.mapper));
	}
	...
	public void validateAndThrowIfInvalid(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5) {
		this.validator.validate(Arguments.of(a1, a2, a3, a4, a5))
				.throwIfInvalid(ConstraintViolationsException::new);
	}

	public void validateAndThrowIfInvalid(A1 a1, A2 a2, A3 a3, A4 a4, A5 a5,
			ConstraintGroup constraintGroup) {
		this.validator.validate(Arguments.of(a1, a2, a3, a4, a5), constraintGroup)
				.throwIfInvalid(ConstraintViolationsException::new);
	}
