 ...
 * @since 0.3.0
 */
public final class Arguments8<A1, A2, A3, A4, A5, A6, A7, A8> {
	 ...
	 * @since 0.16.0
	 */
	public Arguments3<A6, A7, A8> last3() {
	 ...
	 * @since 0.16.0
	 */
	public Arguments4<A5, A6, A7, A8> last4() {
	 ...
	 * @since 0.16.0
	 */
	public Arguments5<A4, A5, A6, A7, A8> last5() {
	 ...
	 * @since 0.16.0
	 */
	public Arguments6<A3, A4, A5, A6, A7, A8> last6() {
	 ...
	 * @since 0.16.0
	 */
	public Arguments7<A2, A3, A4, A5, A6, A7, A8> last7() {
	 ...
	 * @return a new Arguments9 instance with the additional argument
	 * @since 0.16.0
	 */
	public <B> Arguments9<A1, A2, A3, A4, A5, A6, A7, A8, B> append(@Nullable B arg) {
		return new Arguments9<>(this.arg1, this.arg2, this.arg3, this.arg4, this.arg5, this.arg6, this.arg7, this.arg8,
				arg);
	}
	 ...
	 * @since 0.16.0
	 */
	public <B> Arguments9<B, A1, A2, A3, A4, A5, A6, A7, A8> prepend(@Nullable B arg) {
		return new Arguments9<>(arg, this.arg1, this.arg2, this.arg3, this.arg4, this.arg5, this.arg6, this.arg7,
				this.arg8);
	}

	/**
	 * Returns a new Arguments8 instance with the arguments in reverse order.
	 * @return an Arguments8 instance with arguments in reverse order
	 * @since 0.16.0
	 */
	public Arguments8<A8, A7, A6, A5, A4, A3, A2, A1> reverse() {
		return new Arguments8<>(arg8, arg7, arg6, arg5, arg4, arg3, arg2, arg1);
	}
