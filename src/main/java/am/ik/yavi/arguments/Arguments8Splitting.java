...
public class Arguments8Splitting<A1, A2, A3, A4, A5, A6, A7, A8, R1, R2, R3, R4, R5, R6, R7, R8> {
	...
	public <X> Arguments8Validator<A1, A2, A3, A4, A5, A6, A7, A8, X> apply(
		...
		return (a1, a2, a3, a4, a5, a6, a7, a8, locale, constraintContext) -> Validations.apply(f::apply,
				...
				this.v7.validate(a7, locale, constraintContext), this.v8.validate(a8, locale, constraintContext));
	}
