...
public class Arguments8Splitting<A1, A2, A3, A4, A5, A6, A7, A8, R1, R2, R3, R4, R5, R6, R7, R8> {
	...
	public <X> Arguments8Validator<A1, A2, A3, A4, A5, A6, A7, A8, X> apply(
		...
		return new Arguments8Validator<A1, A2, A3, A4, A5, A6, A7, A8, X>() {
			...
			public Arguments8Validator<A1, A2, A3, A4, A5, A6, A7, A8, Supplier<X>> lazy() {
				return ((a1, a2, a3, a4, a5, a6, a7, a8, locale, constraintContext) -> Validations.apply(
						(r1, r2, r3, r4, r5, r6, r7, r8) -> () -> f.apply(r1, r2, r3, r4, r5, r6, r7, r8),
			...
			@Override
			public Validated<X> validate(@Nullable A1 a1, @Nullable A2 a2, @Nullable A3 a3, @Nullable A4 a4, @Nullable A5 a5, @Nullable A6 a6, @Nullable A7 a7, @Nullable A8 a8, Locale locale,
	...
	public <A9, R9> Arguments9Splitting<A1, A2, A3, A4, A5, A6, A7, A8, A9, R1, R2, R3, R4, R5, R6, R7, R8, R9> split(ValueValidator<? super A9, ? extends R9> v9) {
