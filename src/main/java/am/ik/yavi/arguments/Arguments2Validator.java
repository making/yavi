...
public interface Arguments2Validator<A1, A2, X> {
	 ...
	 * @since 0.7.0
	 */
	default <X2> Arguments2Validator<A1, A2, X2> map(
	...
	default <A> Arguments1Validator<A, X> contramap(
			Function<? super A, ? extends Arguments2<A1, A2>> mapper) {
		return (a, locale, constraintGroup) -> {
			final Arguments2<A1, A2> args = mapper.apply(a);
	...
	default X validated(A1 a1, A2 a2, ConstraintGroup constraintGroup)
			throws ConstraintViolationsException {
		return this.validate(a1, a2, constraintGroup)
				.orElseThrow(ConstraintViolationsException::new);
	}

	default X validated(A1 a1, A2 a2, Locale locale)
			throws ConstraintViolationsException {
		return this.validate(a1, a2, locale)
				.orElseThrow(ConstraintViolationsException::new);
	}

	default X validated(A1 a1, A2 a2, Locale locale, ConstraintGroup constraintGroup)
			throws ConstraintViolationsException {
	...
	/**
	 * Use {@link #validated(Object, Object, ConstraintGroup)} instead
	 */
	@Deprecated
	...
	/**
	 * Use {@link #validated(Object, Object)} instead
	 */
	@Deprecated
	default void validateAndThrowIfInvalid(A1 a1, A2 a2) {
		this.validateAndThrowIfInvalid(a1, a2, ConstraintGroup.DEFAULT);
	}
}
