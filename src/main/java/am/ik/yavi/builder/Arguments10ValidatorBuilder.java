...
public final class Arguments10ValidatorBuilder<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10> {
	...
	public <T> Arguments11ValidatorBuilder<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, LocalDate, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, T> _localDate(
			ValueValidator<LocalDate, T> validator) {
		return new Arguments11ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, this.v7, this.v8,
				this.v9, this.v10, validator);
	}

	public Arguments11ValidatorBuilder<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, LocalDate, R1, R2, R3, R4, R5, R6, R7, R8, R9, R10, LocalDate> _localDate(
			String name,
