...
import am.ik.yavi.arguments.Validator5;
 ...
 * @since 0.14.0
 */
public final class Validator5ChainedBuilder<A1, A2, A3, A4, A5> {
	...
	public Validator5ChainedBuilder(ValueValidator<A1, A1> v1, ValueValidator<A2, A2> v2,
			ValueValidator<A3, A3> v3, ValueValidator<A4, A4> v4,
			ValueValidator<A5, A5> v5) {
		this.v1 = v1;
		this.v2 = v2;
		this.v3 = v3;
		this.v4 = v4;
	...
	public Validator6ChainedBuilder<A1, A2, A3, A4, A5, BigDecimal> _bigDecimal(
			String name,
			Function<BigDecimalConstraint<Arguments1<BigDecimal>>, BigDecimalConstraint<Arguments1<BigDecimal>>> constraints) {
		return new Validator6ChainedBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5,
				BigDecimalValidatorBuilder.of(name, constraints).build());
	}

	public Validator6ChainedBuilder<A1, A2, A3, A4, A5, BigInteger> _bigInteger(
			String name,
	...
	public Validator6ChainedBuilder<A1, A2, A3, A4, A5, Boolean> _boolean(String name,
	...
	public Validator6ChainedBuilder<A1, A2, A3, A4, A5, Double> _double(String name,
	...
	public <E extends Enum<E>> Validator6ChainedBuilder<A1, A2, A3, A4, A5, E> _enum(
			String name,
	...
	public Validator6ChainedBuilder<A1, A2, A3, A4, A5, Float> _float(String name,
	...
	public Validator6ChainedBuilder<A1, A2, A3, A4, A5, Instant> _instant(String name,
	...
	public Validator6ChainedBuilder<A1, A2, A3, A4, A5, Integer> _integer(String name,
	...
	public Validator6ChainedBuilder<A1, A2, A3, A4, A5, LocalDateTime> _localDateTime(
			String name,
	...
	public Validator6ChainedBuilder<A1, A2, A3, A4, A5, LocalTime> _localTime(String name,
	...
	public Validator6ChainedBuilder<A1, A2, A3, A4, A5, Long> _long(String name,
	...
	public <T> Validator6ChainedBuilder<A1, A2, A3, A4, A5, T> _object(String name,
	...
	public Validator6ChainedBuilder<A1, A2, A3, A4, A5, OffsetDateTime> _offsetDateTime(
			String name,
	...
	public Validator6ChainedBuilder<A1, A2, A3, A4, A5, Short> _short(String name,
	...
	public Validator6ChainedBuilder<A1, A2, A3, A4, A5, String> _string(String name,
	...
	public Validator6ChainedBuilder<A1, A2, A3, A4, A5, YearMonth> _yearMonth(String name,
	...
	public Validator6ChainedBuilder<A1, A2, A3, A4, A5, Year> _year(String name,
	...
	public Validator6ChainedBuilder<A1, A2, A3, A4, A5, ZonedDateTime> _zonedDateTime(
			String name,
	...
	public <R> Validator5<A1, A2, A3, A4, A5, R> apply(
