 ...
 * @since 0.14.0
 */
public final class Validator3ChainedBuilder<A1, A2, A3> {
	...
	public Validator3ChainedBuilder(ValueValidator<A1, A1> v1, ValueValidator<A2, A2> v2,
			ValueValidator<A3, A3> v3) {
		this.v1 = v1;
		this.v2 = v2;
		this.v3 = v3;
	}

	public Validator4ChainedBuilder<A1, A2, A3, BigDecimal> _bigDecimal(String name,
			Function<BigDecimalConstraint<Arguments1<BigDecimal>>, BigDecimalConstraint<Arguments1<BigDecimal>>> constraints) {
		return new Validator4ChainedBuilder<>(this.v1, this.v2, this.v3,
				BigDecimalValidatorBuilder.of(name, constraints).build());
	}

	public Validator4ChainedBuilder<A1, A2, A3, BigInteger> _bigInteger(String name,
	...
	public Validator4ChainedBuilder<A1, A2, A3, Boolean> _boolean(String name,
	...
	public Validator4ChainedBuilder<A1, A2, A3, Double> _double(String name,
	...
	public <E extends Enum<E>> Validator4ChainedBuilder<A1, A2, A3, E> _enum(String name,
	...
	public Validator4ChainedBuilder<A1, A2, A3, Float> _float(String name,
	...
	public Validator4ChainedBuilder<A1, A2, A3, Instant> _instant(String name,
	...
	public Validator4ChainedBuilder<A1, A2, A3, Integer> _integer(String name,
	...
	public Validator4ChainedBuilder<A1, A2, A3, LocalDateTime> _localDateTime(String name,
	...
	public Validator4ChainedBuilder<A1, A2, A3, LocalTime> _localTime(String name,
	...
	public Validator4ChainedBuilder<A1, A2, A3, Long> _long(String name,
	...
	public <T> Validator4ChainedBuilder<A1, A2, A3, T> _object(String name,
	...
	public Validator4ChainedBuilder<A1, A2, A3, OffsetDateTime> _offsetDateTime(
			String name,
	...
	public Validator4ChainedBuilder<A1, A2, A3, Short> _short(String name,
	...
	public Validator4ChainedBuilder<A1, A2, A3, String> _string(String name,
	...
	public Validator4ChainedBuilder<A1, A2, A3, YearMonth> _yearMonth(String name,
	...
	public Validator4ChainedBuilder<A1, A2, A3, Year> _year(String name,
	...
	public Validator4ChainedBuilder<A1, A2, A3, ZonedDateTime> _zonedDateTime(String name,
	...
	public <R> Validator3<A1, A2, A3, R> apply(Function3<A1, A2, A3, R> f) {
