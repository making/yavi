...
import am.ik.yavi.arguments.Validator8;
 ...
 * @since 0.14.0
 */
public final class Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8> {
	...
	public Validator8ChainedBuilder(ValueValidator<A1, A1> v1, ValueValidator<A2, A2> v2,
	...
	public Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, BigDecimal> _bigDecimal(
			String name,
			Function<BigDecimalConstraint<Arguments1<BigDecimal>>, BigDecimalConstraint<Arguments1<BigDecimal>>> constraints) {
		return new Validator9ChainedBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5,
				this.v6, this.v7, this.v8,
				BigDecimalValidatorBuilder.of(name, constraints).build());
	}

	public Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, BigInteger> _bigInteger(
			String name,
	...
	public Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, Boolean> _boolean(
			String name,
	...
	public Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, Double> _double(
			String name,
	...
	public <E extends Enum<E>> Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, E> _enum(
			String name,
	...
	public Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, Float> _float(
			String name,
	...
	public Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, Instant> _instant(
			String name,
	...
	public Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, Integer> _integer(
			String name,
	...
	public Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, LocalDateTime> _localDateTime(
			String name,
	...
	public Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, LocalTime> _localTime(
			String name,
	...
	public Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, Long> _long(
			String name,
	...
	public <T> Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, T> _object(
			String name,
	...
	public Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, OffsetDateTime> _offsetDateTime(
			String name,
	...
	public Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, Short> _short(
			String name,
	...
	public Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, String> _string(
			String name,
	...
	public Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, YearMonth> _yearMonth(
			String name,
	...
	public Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, Year> _year(
			String name,
	...
	public Validator9ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, A8, ZonedDateTime> _zonedDateTime(
			String name,
	...
	public <R> Validator8<A1, A2, A3, A4, A5, A6, A7, A8, R> apply(
