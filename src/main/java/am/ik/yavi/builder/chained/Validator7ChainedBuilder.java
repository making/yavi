...
import am.ik.yavi.arguments.Validator7;
 ...
 * @since 0.14.0
 */
public final class Validator7ChainedBuilder<A1, A2, A3, A4, A5, A6, A7> {
	...
	public Validator7ChainedBuilder(ValueValidator<A1, A1> v1, ValueValidator<A2, A2> v2,
			ValueValidator<A3, A3> v3, ValueValidator<A4, A4> v4,
			ValueValidator<A5, A5> v5, ValueValidator<A6, A6> v6,
			ValueValidator<A7, A7> v7) {
		this.v1 = v1;
		this.v2 = v2;
		this.v3 = v3;
		this.v4 = v4;
	...
	public Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, BigDecimal> _bigDecimal(
			String name,
			Function<BigDecimalConstraint<Arguments1<BigDecimal>>, BigDecimalConstraint<Arguments1<BigDecimal>>> constraints) {
		return new Validator8ChainedBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5,
				this.v6, this.v7,
				BigDecimalValidatorBuilder.of(name, constraints).build());
	}

	public Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, BigInteger> _bigInteger(
			String name,
	...
	public Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, Boolean> _boolean(
			String name,
			Function<BooleanConstraint<Arguments1<Boolean>>, BooleanConstraint<Arguments1<Boolean>>> constraints) {
		return new Validator8ChainedBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5,
				this.v6, this.v7, BooleanValidatorBuilder.of(name, constraints).build());
	}

	public Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, Double> _double(
			String name,
			Function<DoubleConstraint<Arguments1<Double>>, DoubleConstraint<Arguments1<Double>>> constraints) {
		return new Validator8ChainedBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5,
				this.v6, this.v7, DoubleValidatorBuilder.of(name, constraints).build());
	}

	public <E extends Enum<E>> Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, E> _enum(
			String name,
			Function<EnumConstraint<Arguments1<E>, E>, EnumConstraint<Arguments1<E>, E>> constraints) {
		return new Validator8ChainedBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5,
				this.v6, this.v7, EnumValidatorBuilder.of(name, constraints).build());
	}

	public Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, Float> _float(String name,
			Function<FloatConstraint<Arguments1<Float>>, FloatConstraint<Arguments1<Float>>> constraints) {
		return new Validator8ChainedBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5,
				this.v6, this.v7, FloatValidatorBuilder.of(name, constraints).build());
	}

	public Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, Instant> _instant(
			String name,
			Function<InstantConstraint<Arguments1<Instant>>, InstantConstraint<Arguments1<Instant>>> constraints) {
		return new Validator8ChainedBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5,
				this.v6, this.v7, InstantValidatorBuilder.of(name, constraints).build());
	}

	public Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, Integer> _integer(
			String name,
			Function<IntegerConstraint<Arguments1<Integer>>, IntegerConstraint<Arguments1<Integer>>> constraints) {
		return new Validator8ChainedBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5,
				this.v6, this.v7, IntegerValidatorBuilder.of(name, constraints).build());
	}

	public Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, LocalDateTime> _localDateTime(
			String name,
	...
	public Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, LocalTime> _localTime(
			String name,
	...
	public Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, Long> _long(String name,
			Function<LongConstraint<Arguments1<Long>>, LongConstraint<Arguments1<Long>>> constraints) {
		return new Validator8ChainedBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5,
				this.v6, this.v7, LongValidatorBuilder.of(name, constraints).build());
	}

	public <T> Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, T> _object(
			String name,
			Function<ObjectConstraint<Arguments1<T>, T>, ObjectConstraint<Arguments1<T>, T>> constraints) {
		return new Validator8ChainedBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5,
				this.v6, this.v7, ObjectValidatorBuilder.of(name, constraints).build());
	}

	public Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, OffsetDateTime> _offsetDateTime(
			String name,
	...
	public Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, Short> _short(String name,
			Function<ShortConstraint<Arguments1<Short>>, ShortConstraint<Arguments1<Short>>> constraints) {
		return new Validator8ChainedBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5,
				this.v6, this.v7, ShortValidatorBuilder.of(name, constraints).build());
	}

	public Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, String> _string(
			String name,
			Function<CharSequenceConstraint<Arguments1<String>, String>, CharSequenceConstraint<Arguments1<String>, String>> constraints) {
		return new Validator8ChainedBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5,
				this.v6, this.v7, StringValidatorBuilder.of(name, constraints).build());
	}

	public Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, YearMonth> _yearMonth(
			String name,
	...
	public Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, Year> _year(String name,
			Function<YearConstraint<Arguments1<Year>>, YearConstraint<Arguments1<Year>>> constraints) {
		return new Validator8ChainedBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5,
				this.v6, this.v7, YearValidatorBuilder.of(name, constraints).build());
	}

	public Validator8ChainedBuilder<A1, A2, A3, A4, A5, A6, A7, ZonedDateTime> _zonedDateTime(
			String name,
	...
	public <R> Validator7<A1, A2, A3, A4, A5, A6, A7, R> apply(
