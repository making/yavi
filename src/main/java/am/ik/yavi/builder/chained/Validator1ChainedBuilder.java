 ...
 * @since 0.14.0
 */
public final class Validator1ChainedBuilder<A1> {

	final ValueValidator<A1, A1> v1;

	public Validator1ChainedBuilder(ValueValidator<A1, A1> v1) {
		this.v1 = v1;
	}

	public Validator2ChainedBuilder<A1, BigDecimal> _bigDecimal(String name,
			Function<BigDecimalConstraint<Arguments1<BigDecimal>>, BigDecimalConstraint<Arguments1<BigDecimal>>> constraints) {
		return new Validator2ChainedBuilder<>(this.v1,
				BigDecimalValidatorBuilder.of(name, constraints).build());
	}

	public Validator2ChainedBuilder<A1, BigInteger> _bigInteger(String name,
	...
	public Validator2ChainedBuilder<A1, Boolean> _boolean(String name,
	...
	public Validator2ChainedBuilder<A1, Double> _double(String name,
	...
	public <E extends Enum<E>> Validator2ChainedBuilder<A1, E> _enum(String name,
	...
	public Validator2ChainedBuilder<A1, Float> _float(String name,
	...
	public Validator2ChainedBuilder<A1, Instant> _instant(String name,
	...
	public Validator2ChainedBuilder<A1, Integer> _integer(String name,
	...
	public Validator2ChainedBuilder<A1, LocalDateTime> _localDateTime(String name,
	...
	public Validator2ChainedBuilder<A1, LocalTime> _localTime(String name,
	...
	public Validator2ChainedBuilder<A1, Long> _long(String name,
	...
	public <T> Validator2ChainedBuilder<A1, T> _object(String name,
	...
	public Validator2ChainedBuilder<A1, OffsetDateTime> _offsetDateTime(String name,
	...
	public Validator2ChainedBuilder<A1, Short> _short(String name,
	...
	public Validator2ChainedBuilder<A1, String> _string(String name,
	...
	public Validator2ChainedBuilder<A1, YearMonth> _yearMonth(String name,
	...
	public Validator2ChainedBuilder<A1, Year> _year(String name,
	...
	public Validator2ChainedBuilder<A1, ZonedDateTime> _zonedDateTime(String name,
