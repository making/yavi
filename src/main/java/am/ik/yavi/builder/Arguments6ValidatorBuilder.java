...
public final class Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, A6, R1, R2, R3, R4, R5, R6> {
	...
	public <T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, LocalDate, R1, R2, R3, R4, R5, R6, T> _localDate(
			ValueValidator<LocalDate, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}

	public Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, LocalDate, R1, R2, R3, R4, R5, R6, LocalDate> _localDate(
			String name,
