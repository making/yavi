...
public final class Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, A6, R1, R2, R3, R4, R5, R6>
{
	...
	public Arguments6ValidatorBuilder(ValueValidator<A1, R1> v1, ValueValidator<A2, R2> v2, ValueValidator<A3, R3> v3, ValueValidator<A4, R4> v4, ValueValidator<A5, R5> v5, ValueValidator<A6, R6> v6) {
		this.v1 = v1;
		this.v2 = v2;
		this.v3 = v3;
		this.v4 = v4;
	...
	public <T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, BigDecimal, R1, R2, R3, R4, R5, R6, T> _bigDecimal(ValueValidator<BigDecimal, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}

	public Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, BigDecimal, R1, R2, R3, R4, R5, R6, BigDecimal> _bigDecimal(String name,
	...
	public <T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, BigInteger, R1, R2, R3, R4, R5, R6, T> _bigInteger(ValueValidator<BigInteger, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}

	public Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, BigInteger, R1, R2, R3, R4, R5, R6, BigInteger> _bigInteger(String name,
	...
	public <T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, Boolean, R1, R2, R3, R4, R5, R6, T> _boolean(ValueValidator<Boolean, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}

	public Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, Boolean, R1, R2, R3, R4, R5, R6, Boolean> _boolean(String name,
	...
	public <T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, Double, R1, R2, R3, R4, R5, R6, T> _double(ValueValidator<Double, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}

	public Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, Double, R1, R2, R3, R4, R5, R6, Double> _double(String name,
	...
	public <E extends Enum<E>, T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, E, R1, R2, R3, R4, R5, R6, T> _enum(ValueValidator<E, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}

	public <E extends Enum<E>> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, E, R1, R2, R3, R4, R5, R6, E> _enum(String name,
	...
	public <T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, Float, R1, R2, R3, R4, R5, R6, T> _float(ValueValidator<Float, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}
	...
	public <T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, Instant, R1, R2, R3, R4, R5, R6, T> _instant(ValueValidator<Instant, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}

	public Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, Instant, R1, R2, R3, R4, R5, R6, Instant> _instant(String name,
	...
	public <T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, Integer, R1, R2, R3, R4, R5, R6, T> _integer(ValueValidator<Integer, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}

	public Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, Integer, R1, R2, R3, R4, R5, R6, Integer> _integer(String name,
	...
	public <T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, LocalDateTime, R1, R2, R3, R4, R5, R6, T> _localDateTime(ValueValidator<LocalDateTime, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}

	public Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, LocalDateTime, R1, R2, R3, R4, R5, R6, LocalDateTime> _localDateTime(String name,
	...
	public <T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, LocalTime, R1, R2, R3, R4, R5, R6, T> _localTime(ValueValidator<LocalTime, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}

	public Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, LocalTime, R1, R2, R3, R4, R5, R6, LocalTime> _localTime(String name,
	...
	public <T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, Long, R1, R2, R3, R4, R5, R6, T> _long(ValueValidator<Long, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}
	...
	public <T1, T2> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, T1, R1, R2, R3, R4, R5, R6, T2> _object(ValueValidator<T1, T2> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}
	...
	public <T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, OffsetDateTime, R1, R2, R3, R4, R5, R6, T> _offsetDateTime(ValueValidator<OffsetDateTime, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}

	public Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, OffsetDateTime, R1, R2, R3, R4, R5, R6, OffsetDateTime> _offsetDateTime(String name,
	...
	public <T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, Short, R1, R2, R3, R4, R5, R6, T> _short(ValueValidator<Short, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}
	...
	public <T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, String, R1, R2, R3, R4, R5, R6, T> _string(ValueValidator<String, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}

	public Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, String, R1, R2, R3, R4, R5, R6, String> _string(String name,
	...
	public <T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, YearMonth, R1, R2, R3, R4, R5, R6, T> _yearMonth(ValueValidator<YearMonth, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}

	public Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, YearMonth, R1, R2, R3, R4, R5, R6, YearMonth> _yearMonth(String name,
	...
	public <T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, Year, R1, R2, R3, R4, R5, R6, T> _year(ValueValidator<Year, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}
	...
	public <T> Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, ZonedDateTime, R1, R2, R3, R4, R5, R6, T> _zonedDateTime(ValueValidator<ZonedDateTime, T> validator) {
		return new Arguments7ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, validator);
	}

	public Arguments7ValidatorBuilder<A1, A2, A3, A4, A5, A6, ZonedDateTime, R1, R2, R3, R4, R5, R6, ZonedDateTime> _zonedDateTime(String name,
	...
	public <X> Arguments6Validator<A1, A2, A3, A4, A5, A6, X> apply(Function6<? super R1, ? super R2, ? super R3, ? super R4, ? super R5, ? super R6, ? extends X> f) {
