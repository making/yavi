 ...
 * @since 0.14.0
 */
public final class Arguments5ValidatorBuilder<A1, A2, A3, A4, A5, R1, R2, R3, R4, R5>
{
	...
	public Arguments5ValidatorBuilder(ValueValidator<A1, R1> v1, ValueValidator<A2, R2> v2, ValueValidator<A3, R3> v3, ValueValidator<A4, R4> v4, ValueValidator<A5, R5> v5) {
		this.v1 = v1;
		this.v2 = v2;
		this.v3 = v3;
		this.v4 = v4;
	...
	public <T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, BigDecimal, R1, R2, R3, R4, R5, T> _bigDecimal(ValueValidator<BigDecimal, T> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, BigDecimal, R1, R2, R3, R4, R5, BigDecimal> _bigDecimal(String name,
	...
	public <T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, BigInteger, R1, R2, R3, R4, R5, T> _bigInteger(ValueValidator<BigInteger, T> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, BigInteger, R1, R2, R3, R4, R5, BigInteger> _bigInteger(String name,
	...
	public <T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, Boolean, R1, R2, R3, R4, R5, T> _boolean(ValueValidator<Boolean, T> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, Boolean, R1, R2, R3, R4, R5, Boolean> _boolean(String name,
	...
	public <T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, Double, R1, R2, R3, R4, R5, T> _double(ValueValidator<Double, T> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, Double, R1, R2, R3, R4, R5, Double> _double(String name,
	...
	public <E extends Enum<E>, T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, E, R1, R2, R3, R4, R5, T> _enum(ValueValidator<E, T> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public <E extends Enum<E>> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, E, R1, R2, R3, R4, R5, E> _enum(String name,
	...
	public <T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, Float, R1, R2, R3, R4, R5, T> _float(ValueValidator<Float, T> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, Float, R1, R2, R3, R4, R5, Float> _float(String name,
	...
	public <T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, Instant, R1, R2, R3, R4, R5, T> _instant(ValueValidator<Instant, T> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, Instant, R1, R2, R3, R4, R5, Instant> _instant(String name,
	...
	public <T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, Integer, R1, R2, R3, R4, R5, T> _integer(ValueValidator<Integer, T> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, Integer, R1, R2, R3, R4, R5, Integer> _integer(String name,
	...
	public <T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, LocalDateTime, R1, R2, R3, R4, R5, T> _localDateTime(ValueValidator<LocalDateTime, T> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, LocalDateTime, R1, R2, R3, R4, R5, LocalDateTime> _localDateTime(String name,
	...
	public <T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, LocalTime, R1, R2, R3, R4, R5, T> _localTime(ValueValidator<LocalTime, T> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, LocalTime, R1, R2, R3, R4, R5, LocalTime> _localTime(String name,
	...
	public <T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, Long, R1, R2, R3, R4, R5, T> _long(ValueValidator<Long, T> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, Long, R1, R2, R3, R4, R5, Long> _long(String name,
	...
	public <T1, T2> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, T1, R1, R2, R3, R4, R5, T2> _object(ValueValidator<T1, T2> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public <T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, T, R1, R2, R3, R4, R5, T> _object(String name,
	...
	public <T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, OffsetDateTime, R1, R2, R3, R4, R5, T> _offsetDateTime(ValueValidator<OffsetDateTime, T> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, OffsetDateTime, R1, R2, R3, R4, R5, OffsetDateTime> _offsetDateTime(String name,
	...
	public <T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, Short, R1, R2, R3, R4, R5, T> _short(ValueValidator<Short, T> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, Short, R1, R2, R3, R4, R5, Short> _short(String name,
	...
	public <T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, String, R1, R2, R3, R4, R5, T> _string(ValueValidator<String, T> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, String, R1, R2, R3, R4, R5, String> _string(String name,
	...
	public <T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, YearMonth, R1, R2, R3, R4, R5, T> _yearMonth(ValueValidator<YearMonth, T> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, YearMonth, R1, R2, R3, R4, R5, YearMonth> _yearMonth(String name,
	...
	public <T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, Year, R1, R2, R3, R4, R5, T> _year(ValueValidator<Year, T> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, Year, R1, R2, R3, R4, R5, Year> _year(String name,
	...
	public <T> Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, ZonedDateTime, R1, R2, R3, R4, R5, T> _zonedDateTime(ValueValidator<ZonedDateTime, T> validator) {
		return new Arguments6ValidatorBuilder<>(this.v1, this.v2, this.v3, this.v4, this.v5, validator);
	}

	public Arguments6ValidatorBuilder<A1, A2, A3, A4, A5, ZonedDateTime, R1, R2, R3, R4, R5, ZonedDateTime> _zonedDateTime(String name,
	...
	public <X> Arguments5Validator<A1, A2, A3, A4, A5, X> apply(Function5<? super R1, ? super R2, ? super R3, ? super R4, ? super R5, ? extends X> f) {
		return ArgumentsValidators.split(this.v1, this.v2, this.v3, this.v4, this.v5).apply(f);
	}
