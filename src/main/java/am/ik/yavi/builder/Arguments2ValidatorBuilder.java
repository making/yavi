...
public final class Arguments2ValidatorBuilder<A1, A2, R1, R2> {
	...
	public <T> Arguments3ValidatorBuilder<A1, A2, LocalDate, R1, R2, T> _localDate(
			ValueValidator<LocalDate, T> validator) {
		return new Arguments3ValidatorBuilder<>(this.v1, this.v2, validator);
	}

	public Arguments3ValidatorBuilder<A1, A2, LocalDate, R1, R2, LocalDate> _localDate(String name,
