 ...
 * @since 0.14.0
 */
public final class Arguments2ValidatorBuilder<A1, A2, R1, R2>
{
	...
	public <T> Arguments3ValidatorBuilder<A1, A2, BigDecimal, R1, R2, T> _bigDecimal(ValueValidator<BigDecimal, T> validator) {
	...
	public <T> Arguments3ValidatorBuilder<A1, A2, BigInteger, R1, R2, T> _bigInteger(ValueValidator<BigInteger, T> validator) {
		return new Arguments3ValidatorBuilder<>(this.v1, this.v2, validator);
	}
	...
	public <E extends Enum<E>, T> Arguments3ValidatorBuilder<A1, A2, E, R1, R2, T> _enum(ValueValidator<E, T> validator) {
		return new Arguments3ValidatorBuilder<>(this.v1, this.v2, validator);
	}
	...
	public Arguments3ValidatorBuilder<A1, A2, Float, R1, R2, Float> _float(String name,
	...
	public <T> Arguments3ValidatorBuilder<A1, A2, LocalDateTime, R1, R2, T> _localDateTime(ValueValidator<LocalDateTime, T> validator) {
		return new Arguments3ValidatorBuilder<>(this.v1, this.v2, validator);
	}
	...
	public <T> Arguments3ValidatorBuilder<A1, A2, LocalTime, R1, R2, T> _localTime(ValueValidator<LocalTime, T> validator) {
		return new Arguments3ValidatorBuilder<>(this.v1, this.v2, validator);
	}
	...
	public Arguments3ValidatorBuilder<A1, A2, Long, R1, R2, Long> _long(String name,
	...
	public <T> Arguments3ValidatorBuilder<A1, A2, T, R1, R2, T> _object(String name,
	...
	public <T> Arguments3ValidatorBuilder<A1, A2, OffsetDateTime, R1, R2, T> _offsetDateTime(ValueValidator<OffsetDateTime, T> validator) {
		return new Arguments3ValidatorBuilder<>(this.v1, this.v2, validator);
	}
	...
	public Arguments3ValidatorBuilder<A1, A2, Short, R1, R2, Short> _short(String name,
	...
	public <T> Arguments3ValidatorBuilder<A1, A2, YearMonth, R1, R2, T> _yearMonth(ValueValidator<YearMonth, T> validator) {
		return new Arguments3ValidatorBuilder<>(this.v1, this.v2, validator);
	}
	...
	public Arguments3ValidatorBuilder<A1, A2, Year, R1, R2, Year> _year(String name,
	...
	public <T> Arguments3ValidatorBuilder<A1, A2, ZonedDateTime, R1, R2, T> _zonedDateTime(ValueValidator<ZonedDateTime, T> validator) {
		return new Arguments3ValidatorBuilder<>(this.v1, this.v2, validator);
	}
