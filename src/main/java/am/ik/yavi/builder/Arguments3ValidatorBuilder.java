...
public final class Arguments3ValidatorBuilder<A1, A2, A3, R1, R2, R3>
{
	...
	public <T> Arguments4ValidatorBuilder<A1, A2, A3, BigDecimal, R1, R2, R3, T> _bigDecimal(ValueValidator<BigDecimal, T> validator) {
	...
	public <T> Arguments4ValidatorBuilder<A1, A2, A3, BigInteger, R1, R2, R3, T> _bigInteger(ValueValidator<BigInteger, T> validator) {
		return new Arguments4ValidatorBuilder<>(this.v1, this.v2, this.v3, validator);
	}
	...
	public <T> Arguments4ValidatorBuilder<A1, A2, A3, Boolean, R1, R2, R3, T> _boolean(ValueValidator<Boolean, T> validator) {
		return new Arguments4ValidatorBuilder<>(this.v1, this.v2, this.v3, validator);
	}
	...
	public <T> Arguments4ValidatorBuilder<A1, A2, A3, Double, R1, R2, R3, T> _double(ValueValidator<Double, T> validator) {
		return new Arguments4ValidatorBuilder<>(this.v1, this.v2, this.v3, validator);
	}
	...
	public <E extends Enum<E>, T> Arguments4ValidatorBuilder<A1, A2, A3, E, R1, R2, R3, T> _enum(ValueValidator<E, T> validator) {
		return new Arguments4ValidatorBuilder<>(this.v1, this.v2, this.v3, validator);
	}
	...
	public <T> Arguments4ValidatorBuilder<A1, A2, A3, Instant, R1, R2, R3, T> _instant(ValueValidator<Instant, T> validator) {
		return new Arguments4ValidatorBuilder<>(this.v1, this.v2, this.v3, validator);
	}
	...
	public <T> Arguments4ValidatorBuilder<A1, A2, A3, Integer, R1, R2, R3, T> _integer(ValueValidator<Integer, T> validator) {
		return new Arguments4ValidatorBuilder<>(this.v1, this.v2, this.v3, validator);
	}
	...
	public <T> Arguments4ValidatorBuilder<A1, A2, A3, LocalDateTime, R1, R2, R3, T> _localDateTime(ValueValidator<LocalDateTime, T> validator) {
		return new Arguments4ValidatorBuilder<>(this.v1, this.v2, this.v3, validator);
	}
	...
	public <T> Arguments4ValidatorBuilder<A1, A2, A3, LocalTime, R1, R2, R3, T> _localTime(ValueValidator<LocalTime, T> validator) {
		return new Arguments4ValidatorBuilder<>(this.v1, this.v2, this.v3, validator);
	}
	...
	public <T1, T2> Arguments4ValidatorBuilder<A1, A2, A3, T1, R1, R2, R3, T2> _object(ValueValidator<T1, T2> validator) {
		return new Arguments4ValidatorBuilder<>(this.v1, this.v2, this.v3, validator);
	}
	...
	public <T> Arguments4ValidatorBuilder<A1, A2, A3, OffsetDateTime, R1, R2, R3, T> _offsetDateTime(ValueValidator<OffsetDateTime, T> validator) {
		return new Arguments4ValidatorBuilder<>(this.v1, this.v2, this.v3, validator);
	}

	public Arguments4ValidatorBuilder<A1, A2, A3, OffsetDateTime, R1, R2, R3, OffsetDateTime> _offsetDateTime(String name,
	...
	public <T> Arguments4ValidatorBuilder<A1, A2, A3, String, R1, R2, R3, T> _string(ValueValidator<String, T> validator) {
		return new Arguments4ValidatorBuilder<>(this.v1, this.v2, this.v3, validator);
	}
	...
	public <T> Arguments4ValidatorBuilder<A1, A2, A3, YearMonth, R1, R2, R3, T> _yearMonth(ValueValidator<YearMonth, T> validator) {
		return new Arguments4ValidatorBuilder<>(this.v1, this.v2, this.v3, validator);
	}
	...
	public <T> Arguments4ValidatorBuilder<A1, A2, A3, ZonedDateTime, R1, R2, R3, T> _zonedDateTime(ValueValidator<ZonedDateTime, T> validator) {
		return new Arguments4ValidatorBuilder<>(this.v1, this.v2, this.v3, validator);
	}
