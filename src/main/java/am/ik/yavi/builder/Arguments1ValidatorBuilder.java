...
public final class Arguments1ValidatorBuilder<A1, R1>
{
	...
	public <T> Arguments2ValidatorBuilder<A1, LocalDateTime, R1, T> _localDateTime(ValueValidator<LocalDateTime, T> validator) {
		return new Arguments2ValidatorBuilder<>(this.v1, validator);
	}
	...
	public <T> Arguments2ValidatorBuilder<A1, OffsetDateTime, R1, T> _offsetDateTime(ValueValidator<OffsetDateTime, T> validator) {
		return new Arguments2ValidatorBuilder<>(this.v1, validator);
	}
	...
	public <T> Arguments2ValidatorBuilder<A1, ZonedDateTime, R1, T> _zonedDateTime(ValueValidator<ZonedDateTime, T> validator) {
		return new Arguments2ValidatorBuilder<>(this.v1, validator);
	}
