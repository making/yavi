...
public class Combining8<E, T1, T2, T3, T4, T5, T6, T7, T8> {
	...
	public Combining8(Validation<E, T1> v1, Validation<E, T2> v2, Validation<E, T3> v3, Validation<E, T4> v4,
	...
	public <R, V extends Validation<E, R>> V apply(Function8<T1, T2, T3, T4, T5, T6, T7, T8, R> f) {
		...
		final Validation<E, Function1<T4, Function1<T5, Function1<T6, Function1<T7, Function1<T8, R>>>>>> apply3 = v3
			.apply(apply2);
		final Validation<E, Function1<T5, Function1<T6, Function1<T7, Function1<T8, R>>>>> apply4 = v4.apply(apply3);
		final Validation<E, Function1<T6, Function1<T7, Function1<T8, R>>>> apply5 = v5.apply(apply4);
	...
	public <T9> Combining9<E, T1, T2, T3, T4, T5, T6, T7, T8, T9> combine(Validation<E, T9> v9) {
