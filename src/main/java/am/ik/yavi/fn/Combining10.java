...
public class Combining10<E, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10> {
	...
	public Combining10(Validation<E, T1> v1, Validation<E, T2> v2, Validation<E, T3> v3, Validation<E, T4> v4,
	...
	public <R, V extends Validation<E, R>> V apply(Function10<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, R> f) {
		...
		final Validation<E, Function1<T6, Function1<T7, Function1<T8, Function1<T9, Function1<T10, R>>>>>> apply5 = v5
			.apply(apply4);
		final Validation<E, Function1<T7, Function1<T8, Function1<T9, Function1<T10, R>>>>> apply6 = v6.apply(apply5);
		final Validation<E, Function1<T8, Function1<T9, Function1<T10, R>>>> apply7 = v7.apply(apply6);
	...
	public <T11> Combining11<E, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11> combine(Validation<E, T11> v11) {
