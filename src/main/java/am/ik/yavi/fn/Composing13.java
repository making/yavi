 ...
 * @since 0.6.0
 */
public class Composing13<E, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13> {
	...
	public Composing13(Validation<E, T1> v1, Validation<E, T2> v2, Validation<E, T3> v3,
	...
	public <R> Validation<E, R> apply(
		...
		return v13.apply(v12.apply(v11.apply(v10.apply(
				v9.apply(v8.apply(v7.apply(v6.apply(v5.apply(v4.apply(v3.apply(v2.apply(
						v1.apply(Validation.success(Functions.curry(f)))))))))))))));
	}

	public <T14> Composing14<E, T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14> compose(
